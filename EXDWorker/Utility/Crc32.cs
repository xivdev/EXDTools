...
public static class Crc32
{
    ...
    {
        return Get( value, 0, value.Length, crc );
    }
    ...
    /// <returns>The CRC32 of the input data</returns>
    [MethodImpl( MethodImplOptions.AggressiveInlining )]
    public static uint Get( ReadOnlySpan< char > buffer, uint crc = CrcInitialSeed )
    {
        return Get( buffer, 0, buffer.Length, crc );
    }
    ...
    public static uint Get( ReadOnlySpan< char > buffer, int start, int size, uint crc = CrcInitialSeed )
    {
