...
public class MultiLinkRefValidator : Validator
{
	...
	public MultiLinkRefValidator(IGameFileAccess gameData) : base(gameData) { }

	public MultiLinkRefValidator(IGameFileAccess gameData, Dictionary<string, List<int>> ignoredValues) : base(gameData)
	{
